...
model_path = './drone_agent_awr_' + date_time + '.pt'
...
if __name__ == '__main__':
    ...
    TRAINING_STATE = 1
    RECORDING_STATE = 2
    RL_STATE = TRAINING_STATE

    recorder = BinaryRecorder(record_path)
    ...
    while True:
        ...
        if RL_STATE is RECORDING_STATE:
            recorder.save(state, action, reward, next_state, done)
        ...
        if done:
            ...
            if RL_STATE is TRAINING_STATE:
                ...
                if success_cnt >= 50:
                    ...
                    RL_STATE = RECORDING_STATE
                    episode = 0

                    print('recording state on')
